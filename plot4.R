...
plot(mydata$fulltime, mydata$Global_active_power, type="l", xlab="", ylab="Global Active Power")
plot(mydata$fulltime, mydata$Voltage, type="l", xlab="datetime", ylab="Voltage")
...
plot(mydata$fulltime, mydata$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
